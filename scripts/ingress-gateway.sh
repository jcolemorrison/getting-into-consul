...
echo "Hello Consul Ingress Gateway!"
...
# Put ingress gateway service token here for the -token option!
[Service]
ExecStart=/usr/bin/consul connect envoy -sidecar-for=ig -token=ig_service_token
